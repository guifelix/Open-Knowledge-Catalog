---
id: OKC-00089
title: 'Competitor Assessment: openwiki (npm)'
status: Done
assignee:
  - '@orchestrator'
created_date: '2026-07-27 22:23'
...
Research and assess the npm package `openwiki` for OKF/agent knowledge ecosystem.
...
- Write assessment file at `docs/competitors/openwiki-assessment.md`
...
- [ ] #4 Assessment file written to docs/competitors/openwiki-assessment.md
