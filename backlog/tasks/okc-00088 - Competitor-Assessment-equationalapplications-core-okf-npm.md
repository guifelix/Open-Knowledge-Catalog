---
id: OKC-00088
title: 'Competitor Assessment: @equationalapplications/core-okf (npm)'
status: Done
assignee:
  - '@orchestrator'
created_date: '2026-07-27 22:22'
...
dependencies: []
references:
  - 'https://www.npmjs.com/package/@equationalapplications/core-okf'
  - >-
    https://github.com/equationalapplications/expo-llm-wiki/tree/main/packages/okf
documentation:
...
Research and assess the npm package `@equationalapplications/core-okf` for OKF ecosystem.
...
- Write assessment file at `docs/competitors/equationalapplications-core-okf-assessment.md`
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Package found and documented on npmjs.com
- [ ] #2 GitHub repository identified and analyzed
- [ ] #3 Feature comparison table with OKC completed
- [ ] #4 Assessment file written to docs/competitors/equationalapplications-core-okf-assessment.md
