---
id: OKC-00082
title: 'Competitor Assessment: okapi-okf (npm)'
status: Done
assignee:
  - '@orchestrator'
...
dependencies: []
references:
  - 'https://www.npmjs.com/package/okapi-okf'
  - 'https://github.com/search?q=okapi-okf'
documentation:
...
Research and assess the npm package `okapi-okf` for OKF ecosystem.
...
- Write assessment file at `docs/competitors/okapi-okf-assessment.md`
...
- [ ] #4 Assessment file written to docs/competitors/okapi-okf-assessment.md
