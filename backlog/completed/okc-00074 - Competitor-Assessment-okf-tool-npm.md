---
id: OKC-00074
title: 'Competitor Assessment: okf-tool (npm)'
status: Done
assignee:
  - '@orchestrator'
...
dependencies: []
references:
  - 'https://www.npmjs.com/package/okf-tool'
  - 'https://github.com/search?q=okf-tool'
documentation:
...
Research and assess the npm package `okf-tool` for OKF ecosystem.
...
- Write assessment file at `docs/competitors/okf-tool-assessment.md`
...
- [ ] #4 Assessment file written to docs/competitors/okf-tool-assessment.md
