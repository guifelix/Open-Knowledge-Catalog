---
id: OKC-00076
title: 'Competitor Assessment: @copperbox/okf-mcp (npm)'
status: Done
assignee:
  - '@orchestrator'
...
Research and assess the npm package `@copperbox/okf-mcp` for OKF ecosystem.
...
- Write assessment file at `docs/competitors/copperbox-okf-mcp-assessment.md`
...
- [ ] #4 Assessment file written to docs/competitors/copperbox-okf-mcp-assessment.md
